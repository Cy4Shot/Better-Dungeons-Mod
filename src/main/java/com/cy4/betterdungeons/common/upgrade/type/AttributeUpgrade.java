...
public class AttributeUpgrade extends PlayerUpgrade {
	...
	public AttributeUpgrade(int cost, Attribute attribute, Modifier modifier) {
		this(cost, Registry.ATTRIBUTE.getKey(attribute).toString(), modifier);
	}

	public AttributeUpgrade(int cost, String attribute, Modifier modifier) {
		super(cost);
	...
	public static class Modifier {
		...
		public AttributeModifier toMCModifier() {
			return new AttributeModifier(UUID.fromString(this.id), this.name, this.amount,
					AttributeModifier.Operation.byId(this.operation));
		}
	}
