...
import com.cy4.betterdungeons.core.util.nbt.BlockStateSerializationHelper;
...
public class MultiblockBlockModel {
    ...
    public String serializePretty() {
        if(width == 0 || height == 0 || depth == 0) {
            BetterDungeons.LOGGER.warn("Can not serialize model for type: '%s', invalid dimensions: w=%d, h=%d, d=%d", id, width, height, depth);
            return "";
        }
